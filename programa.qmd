...
| 09/04/25   |    2            | Visão Geral RStudio/Quarto/R/Git/GitHub III  | 
| 11/04/25   |    2            | Introdução à Linguagem R (Parte 1)           | 
| 16/04/25   |    2            | Introdução à Linguagem R (Parte 2)           |  
...
| 07/05/25   |    2            | Manipulação de dados com dplyr (Parte 3)     | 
| 09/05/25   |    2            | Reestruturação de dados com tidyr            | 
...
| 30/05/25   |    2            | Análise Exploratória de Dados                |
