...
## Objetivo Geral (Versão Aprimorada)

Esta disciplina aborda os fundamentos da Ciência de Dados através da 
metodologia CRISP-DM (*Cross-Industry Standard Process for Data Mining*), 
combinando ferramentas computacionais modernas (linguagem R, IDERStudio, 
...
## Objetivos Específicos (Versão Aprimorada)
...
- 4.4. Simulação de Monte Carlo aplicada à Administração
...
| 18/06/25   |    2            | Análise Exploratória de Dados                | 
