...
combinando ferramentas computacionais modernas (R, RStudio, Quarto, Git/GitHub), 
manipulação e visualização de dados e conceitos básicos de estatística e 
probabilidade. O curso introduz os princípios do processo estruturado 
de análise de dados, apresentando técnicas de manipulação de dados, 
estatística descritiva, visualização e elementos de inferência 
estatística organizadas segundo as fases do CRISP-DM. O propósito 
é desenvolver no estudante de Administração habilidades iniciais 
