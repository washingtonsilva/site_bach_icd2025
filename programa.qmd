...
administração, desde estatística e probabilidade até programação e aplicações 
práticas, para equipar o graduando com um sólido conhecimento básico para 
trabalhar com análise de dados em contextos empresariais. O curso fornece 
uma introdução aos princípios do processo de análise de dados, com exemplos 
práticos sobre como aplicá-los em decisões. São apresentados 
conceitos essenciais de manipulação de dados, estatística descritiva, 
visualização e fundamentos de probabilidade e inferência, proporcionando ao 
estudante habilidades críticas para analisar dados de forma eficaz na era 
da Ciência de Dados. O objetivo final é preparar os graduandos para o mercado 
de trabalho atual, tornando-os capazes de coletar, preparar, analisar e 
comunicar insights baseados em dados em um contexto de negócios.
...
a importação, organização, visualização e análise estatística de dados.
...
5. Capacitar o graduando para a criação de relatórios e dashboards usando 
...
Os pontos referentes às avaliações serão distribuídos da seguinte forma:
...
- Avaliação 1 (33 pontos): Fundamentos de R e Manipulação de Dados
    ...
    - Entrega: Documento Quarto via GitHub

- Avaliação 2 (33 pontos): Estatística Descritiva e Visualização

    - Aplicada após o módulo 5
    - Projeto em duplas: análise exploratória e visualizações
    - Entrega: Documento Quarto com análises e visualizações comentadas
...
- Avaliação 3 (34 pontos): Projeto Final 
    ...
    - Entrega: Relatório Quarto ou Dashboard analíticos

Para aprovação, é necessária a obtenção de pelo menos 60 pontos. Pode haver 
alterações no conteúdo das avaliações conforme o andamento da disciplina e 
rendimento da turma.
...
### 1. Introdução à Ciência de Dados para Administração

- 1.1. O que é Ciência de Dados e aplicações
- 1.2. CRISP-DM: Um processo de análise de dados 
- 1.3. Tipos de análise: descritiva, diagnóstica e preditiva
...
Entre os recursos didáticos utilizados na disciplina estão: Slides e 
notas de aula, tutoriais desenvolvidos em Quarto, aulas 
computacionais práticas listas de exercícios aplicados, conjuntos de 
dados reais e simulados para análise, repositório GitHub da disciplina 
para compartilhamento de materiais e submissão de atividades, e ambiente 
virtual de aprendizagem para suporte.
...
e sistema de publicação Quarto. O aprendizado será estruturado por meio de 
...
|:-----------:|:---------------:|:-------------------------------------------:|
| 26/03/25   |    2            | Apresentação da Disciplina                   |
|            |                 | O que é Ciência de Dados e aplicações        |
